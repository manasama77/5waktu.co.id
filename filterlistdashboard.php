...
$kueri_waiting = mysqli_query($con, "SELECT * FROM tbl_report AS report LEFT JOIN tbl_product_catalog AS catalog ON report.id_product_catalog = catalog.id_product_catalog WHERE catalog.product_name LIKE '%$keyword%' ORDER BY id_report DESC LIMIT $batas");
$row = mysqli_num_rows($kueri_waiting);
?>
<div class="table-responsive">
<h3>History Pengiriman</h3>
<form id="form1" name="form1" method="post" action="admin.php?page=dashboard&&halaman=1&&pencarian=true">
Pencarian by Product
...
<table width="100%" class="table table-hover">
  ...
  <tr>
	...
	echo strtoupper($data_waiting['status']);
	echo("<br>");
	echo $late;
