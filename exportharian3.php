<?php
//$excel_harian=$_REQUEST['excel_harian'];
$excel_harian = "2017-07-27";
$time  = strtotime($excel_harian);
$day   = date('d',$time);
/*
// Mendefinisikan nama file ekspor "hasil-export.xls"
header("Content-Disposition: attachment; filename=limawaktulogistic-export-data-".$excel_harian.".xls");
...
WHERE tbl_pengiriman.exit_date = '$excel_harian'
LIMIT 5 OFFSET 30
");
$no = 0;
?>
...
<table border="1">
	<tr>
		<td align="center" colspan="27"><h3>Report Daily - <?=$excel_harian;?></h3></td>
    </tr>
	<tr>
	...
	while($data = mysqli_fetch_array($sql))
	{
		...
		$notes=$data['notes'];		
		$kueri_temp=mysqli_query($con,"SELECT
	...
	<?php
	$kueri_produk_name=mysqli_query($con,"SELECT
		...
		<td align="left" valign="top" >
				...
				if($data['status_pengiriman']=="delivered")
				{
					if($data['late']<0)
					{
						...
						$status_penerimaan=strtoupper($data['status_penerimaan']);						$late = "0";
						echo "$late";
	...
	?>
			<tr>
				...
				<td rowspan="<?=$row;?>" align="center" valign="top" ><?=$notes;?></td>				<td rowspan="<?=$row;?>" align="center" valign="top" ><?=$late_penalty;?></td>
			</tr>
			<?php
	...
	?>
    <?php
	$kueri_sum_harga=mysqli_query($con,"SELECT SUM(tbl_pengiriman.sum_harga) AS sum_total_harga FROM tbl_pengiriman WHERE tbl_pengiriman.exit_date='$excel_harian'");
	$data_sum_harga=mysqli_fetch_array($kueri_sum_harga);
	$sum_total_harga=$data_sum_harga['sum_total_harga'];
	?>
    <tr>
    	<td align="right" colspan="3"><b>Sum Total Harga</b></td>
        <td align="left" colspan="24"><b><?=number_format($sum_total_harga);?></b></td>			<tr>		<td align="right" colspan="3"><b>Sum Total Late Penalty</b></td>				<td align="left" colspan="24"><b><?=number_format($sum_total_late_penalty);?></b></td>
    </tr>		<?php	$grand_total = $sum_total_harga - $sum_total_late_penalty;	?>		<tr>		<td align="right" colspan="3"><b>Grand Total</b></td>		<td align="left" colspan="24"><b><?=number_format($grand_total);?></b></td>	</tr>
	<tr>
