...
?>
		<div class="container">
			<div class="widget-header"><i class="fa fa-list-alt"></i><h3>Add Satuan Harga Electone</h3>
		</div>
		<div class="widget-content">
		<div id="formcontrols" class="tab-pane active">
			<form id="add_dealer1" class="form-horizontal" action="admin.php?page=addsatuanhargaelectone&&subpage=2" method="post">
				<fieldset>
...
?>
		...
		<div class="widget-content">
		<div id="formcontrols" class="tab-pane active">
			<form id="add_satuanhargaelectone" class="form-horizontal" action="prosesaddsatuanhargaelectone.php" method="post">
				<fieldset>
					...
					<div class="control-group">
						<label class="control-label">Satuan Harga Electone</label>
						<div class="controls">
							Rp. <input name="satuan_harga_electone" class="text" id="satuan_harga_electone" size="7" maxlength="7">
						</div>
					</div>
		...
		$( "#add_satuanhargaelectone" ).validate({
		  rules: {
			satuan_harga_electone: {
			  required: true,
			  digits: true
			},
			id_kota: {
