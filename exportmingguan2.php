...
<table border="1">
	...
	?>
			<tr>
				<td <?=$rowspan;?> align="center" valign="top" ><?=$data['do_num'];?></td>
				<td <?=$rowspan;?> align="center" valign="top" ><?=$data['nama_gudang'];?></td>
				<td <?=$rowspan;?> align="center" valign="top" ><?=$data['do_print_date'];?></td>
				<td <?=$rowspan;?> align="center" valign="top" ><?=$data['exit_date'];?></td>
				...
				<td <?=$rowspan;?> align="center" valign="top" ><?=$data['date_terima_ekspedisi'];?></td>
				<td <?=$rowspan;?> align="center" valign="top" ><?=$data['estimation_date'];?></td>
				<td <?=$rowspan;?> align="center" valign="top" ><?=$data['received_date'];?></td>
				<td <?=$rowspan;?> align="center" valign="top" ><?=$data['received_num'];?></td>
				<td <?=$rowspan;?> align="center" valign="top" ><?=$data['nama_dealer'];?></td>
				<td <?=$rowspan;?> align="center" valign="top" ><?=$data['nama_kota'];?></td>
				<td <?=$rowspan;?> align="center" valign="top" ><?=$data['nama_ekspedisi'];?></td>
				<?php
				if($limit==1)
				{
				?>
				...
				<td <?=$rowspan;?> align="right" valign="top" >
				<?php
				...
				<td <?=$rowspan;?> align="right" valign="top" ><?=number_format($data['sum_harga']);?></td>
				<td <?=$rowspan;?> align="center" valign="top" ><?=$data['no_polisi'];?></td>
				<td <?=$rowspan;?> align="center" valign="top" ><?=$data['nama_driver'];?></td>
				<td <?=$rowspan;?> align="center" valign="top" ><?=strtoupper($data['status_pengiriman']);?></td>
				<td <?=$rowspan;?> align="center" valign="top" >
				<?php
				...
				<td <?=$rowspan;?> align="center" valign="top" ><?=$received_name;?></td>
				<td <?=$rowspan;?> align="center" valign="top" ><?=$notes;?></td>
			</tr>
	<?php
	}
	?>
