...
<table width="100%" border="1" cellspacing="2" cellpadding="5">
  <tr>
    ...
    <td align="center"  bgcolor="grey"><b>Notes</b></td>
    <td align="center"  bgcolor="grey"><b>Status</b></td>
  ...
  <tr>
    ...
    <td width="5%" align="center">
	<?php
	if($data_report['do_print_date']=="0000-00-00" && $data_report['exit_date']=="0000-00-00" && $data_report['received_date']=="0000-00-00")
	{
		$status="waiting";
		$late = NULL;
	}
	elseif($data_report['do_print_date']!=="0000-00-00" && $data_report['exit_date']="0000-00-00" && $data_report['received_date']=="0000-00-00")
	{
		$status="waiting";
	}
	elseif($data_report['do_print_date']!=="0000-00-00" && $data_report['exit_date']!=="0000-00-00" && $data_report['received_date']==NULL)
	{
		$status="progress";
		$late = NULL;
	}
