...
<div class="box-body">
	...
	<table id="mytable" name="mytable" class="table table-bordered table-striped small">
		<thead>
			<tr>
				<th style="text-align:center;" colspan="27">All Data - <?=$excel_start;?> ~ <?=$excel_end;?></th>
			<tr>
			<tr>
...
function exportexcel() {
	$("#mytable").table2excel({
		name: "Export All Data <?=$excel_start;?> - <?=$excel_end;?>",
		filename: "Export All Data <?=$excel_start;?> - <?=$excel_end;?>.xls",
		fileext: ".xls"
	});
}
</script>