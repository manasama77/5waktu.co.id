...
header("Content-Disposition: attachment; filename=limawaktulogistic-export-data-Bulan-Ke-".$excel_bulanan.".xls");
...
include("config.php");
	...
	WHERE MONTH(tbl_pengiriman.exit_date) = '$excel_bulanan' AND YEAR(tbl_pengiriman.exit_date) = '$excel_tahun'
	");
	$no = 0;
?>
<style>
...
<table border="1">
	<tr>
    	<td align="center" colspan="27"><h3>Report Monthly <?=$excel_bulanan;?></h3></td>
    </tr>
	<tr>
