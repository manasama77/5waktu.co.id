...
$kueri = mysqli_query($con, "UPDATE tbl_mobil SET no_polisi = '$no_polisi', merk= '$merk', jenis= '$jenis', jumlah_ban= '$jumlah_ban', isi_silinder= '$isi_silinder', tahun_pembuatan= '$tahun_pembuatan', no_rangka= '$no_rangka', no_mesin= '$no_mesin', masa_berlaku_stnk= '$masa_berlaku_stnk', bahan_bakar= '$bahan_bakar', warna= '$warna', id_driver= '$id_driver' WHERE id_mobil = '$id'");
