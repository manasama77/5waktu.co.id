...
?>
		<div class="container">
			<div class="widget-header"><i class="fa fa-list-alt"></i><h3>Add Satuan Harga Dasar</h3>
		</div>
		<div class="widget-content">
		<div id="formcontrols" class="tab-pane active">
			<form id="add_dealer1" class="form-horizontal" action="admin.php?page=addsatuanhargakota&&subpage=2" method="post">
				<fieldset>
...
?>
		...
		<div class="widget-content">
		<div id="formcontrols" class="tab-pane active">
			<form id="add_satuanhargakota" class="form-horizontal" action="prosesaddsatuanhargakota.php" method="post">
				<fieldset>
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							{
								$id_kategori_produk=$data_kategori_produk['id_kategori_produk'];
								$nama_kategori_produk=$data_kategori_produk['nama_kategori_produk'];
							?>
							  <option value="<?php echo $id_kategori_produk; ?>"><?php echo $nama_kategori_produk; ?></option>
							<?php
							}
							?>
							</select>
					...
					<div class="control-group">
						...
						<div class="controls">
							Rp. <input name="satuan_harga" class="text" id="satuan_harga" size="7" maxlength="7">
						</div>
					</div>
