...
?>
		<div class="container">
			<div class="widget-header"><i class="fa fa-list-alt"></i><h3>Add Satuan Harga Clavinova</h3>
		</div>
		<div class="widget-content">
		<div id="formcontrols" class="tab-pane active">
			<form id="add_dealer1" class="form-horizontal" action="admin.php?page=addsatuanhargaclavinova&&subpage=2" method="post">
				<fieldset>
...
?>
		...
		<div class="widget-content">
		<div id="formcontrols" class="tab-pane active">
			<form id="add_satuanhargaclavinova" class="form-horizontal" action="prosesaddsatuanhargaclavinova.php" method="post">
				<fieldset>
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<?php
							$kueri_kota = mysqli_query($con, "SELECT * FROM tbl_kota WHERE id_provinsi = '$id_provinsi' AND satuan_penghitungan = 'weight' ORDER BY nama_kota ASC");
					...
					<div class="control-group">
						<label class="control-label">Satuan Harga Clavinova</label>
						<div class="controls">
							Rp. <input name="satuan_harga_clavinova" class="text" id="satuan_harga_clavinova" size="7" maxlength="7">
						</div>
					</div>
		...
		$( "#add_satuanhargaclavinova" ).validate({
		  rules: {
			satuan_harga_clavinova: {
			  required: true,
			  digits: true
			},
			id_kota: {
