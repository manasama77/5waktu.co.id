...
?>
		<div class="container">
			<div class="widget-header"><i class="fa fa-list-alt"></i><h3>Add Satuan Harga Minimum</h3>
		</div>
		<div class="widget-content">
		<div id="formcontrols" class="tab-pane active">
			<form id="add_dealer1" class="form-horizontal" action="admin.php?page=addsatuanhargamin&&subpage=2" method="post">
				<fieldset>
...
?>
		...
		<div class="widget-content">
		<div id="formcontrols" class="tab-pane active">
			<form id="add_satuanhargamin" class="form-horizontal" action="prosesaddsatuanhargamin.php" method="post">
				<fieldset>
					...
					<div class="control-group">
						<label class="control-label">Satuan Harga Minimum</label>
						<div class="controls">
							Rp. <input name="satuan_harga_minimum" class="text" id="satuan_harga_minimum" size="7" maxlength="7">
						</div>
					</div>
		...
		$( "#add_satuanhargamin" ).validate({
		  rules: {
			satuan_harga_minimum: {
			  required: true,
			  digits: true
			},
			id_kota: {
