...
<div align="center">
    ...
    {
        $previous=$halaman-1;
        echo "<A HREF=$file?page=pengiriman&&halaman=1&&status=waiting><< First</A> | 
            <A HREF=$file?page=pengiriman&&halaman=$previous&&status=waiting>< Previous</A> | ";
    }
    else
    { 
        echo "<< First | < Previous | ";
    ...
    for($i=$halaman-2;$i<$halaman;$i++)
    {
      if ($i < 1) 
          continue;
      $angka .= "<a href=$file?page=pengiriman&&halaman=$i&&status=waiting>$i</A> ";
    }
    ...
    $angka .= ($halaman+2<$jmlhalaman ? " ...  
              <a href=$file?page=pengiriman&&halaman=$jmlhalaman&&status=waiting>$jmlhalaman</A> " : " ");
    ...
    {
        $next=$halaman+1;
        echo " | <A HREF=$file?page=pengiriman&&halaman=$next&&status=waiting>Next ></A> | 
      <A HREF=$file?page=pengiriman&&halaman=$jmlhalaman&&status=waiting>Last >></A> ";
    }
    else
    { 
        echo " | Next > | Last >>";
