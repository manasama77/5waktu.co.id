...
WHERE pengiriman.exit_date = '$excel_harian'");
...
<div class="box-body">
	...
	<table id="mytable" name="mytable" class="table table-bordered table-striped small">
		<thead>
			<tr>
				<th style="text-align:center;" colspan="27">Report Daily - <?=$excel_harian;?></th>
			<tr>
			<tr>
...
function exportexcel() {
	$("#mytable").table2excel({
		name: "Export Harian - <?=$excel_harian;?>",
		filename: "Export Harian - <?=$excel_harian;?>.xls",
		fileext: ".xls"
	});
}
</script>