...
$sql = "SELECT * FROM tbl_pengiriman AS p LEFT JOIN tbl_kota AS kota ON p.id_kota = kota.id_kota LEFT JOIN tbl_dealer AS dealer ON p.id_dealer = dealer.id_dealer WHERE (p.status_pengiriman='progress' $qdeal)";
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$nestedData[] = '<button type="button" class="btn btn-info btn-sm btn-block" onClick="loadprogressmodal('.$row['id_pengiriman'].')">'.$row['do_num'].'</button>';
