...
<table border="1">
	...
	<tr>
		...
		<th align="center">Late Penalty</th>
	...
	?>
			...
			<tr>
				...
				<td align="center" valign="top" ><?=$late_penalty;?></td>
    ...
    <tr>
        ...
        <td align="left" colspan="24"><b><?=number_format($sum_total_harga);?></b></td>
		
	<tr>
		<td align="right" colspan="3"><b>Sum Total Late Penalty</b></td>
		
		<td align="left" colspan="24"><b><?=number_format($sum_total_late_penalty);?></b></td>
	...
	<tr>
		...
		<td align="left" colspan="24"><b><?=number_format($grand_total);?></b></td>
	</tr>
