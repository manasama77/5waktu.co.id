...
<table border="1" class="table2excel" data-tableName="Test Table 1">
	<tr>
    	<td align="center" colspan="26"><h3>Delivery Report - All Data</h3></td>
    </tr>
	<tr>
	...
	?>
			<tr>
				<td align="center" valign="top" ><?=$data['do_num'];?> a<b><?=$row;?></b></td>
	...
	?>
			<tr>
				<td rowspan="<?=$row;?>" align="center" valign="top" ><?=$data['do_num'];?> <b><?=$row;?></b></td>
