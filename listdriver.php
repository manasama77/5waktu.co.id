...
<div align="center">
    ...
    $tampil2="select * from tbl_driver";
    ...
    {
        $previous=$halaman-1;
        echo "<A HREF=$file?page=configuration&&tab=driver&&halaman=1><< First</A> | 
            <A HREF=$file?page=configuration&&tab=driver&&halaman=$previous>< Previous</A> | ";
    }
    else
    { 
        echo "<< First | < Previous | ";
    ...
    for($i=$halaman-2;$i<$halaman;$i++)
    {
      if ($i < 1) 
          continue;
      $angka .= "<a href=$file?page=configuration&&tab=driver&&halaman=$i>$i</A> ";
    }
    ...
    $angka .= ($halaman+2<$jmlhalaman ? " ...  
              <a href=$file?page=configuration&&tab=driver&&halaman=$jmlhalaman>$jmlhalaman</A> " : " ");
    ...
    {
        $next=$halaman+1;
        echo " | <A HREF=$file?page=configuration&&tab=driver&&halaman=$next>Next ></A> | 
      <A HREF=$file?page=configuration&&tab=driver&&halaman=$jmlhalaman>Last >></A> ";
    }
    else
    { 
        echo " | Next > | Last >>";
